...
export const getFileList = () => {
  return new Rest().get({ url: "/api/file/firmware/list" });
};

export const uploadFirmware = (formData) => {
  return new Rest().formPost({ 
    url: "/api/file/firmware/upload", 
    data: formData 
  });
};

export const deleteFirmware = (fileName) => {
  return new Rest().delete({ 
    url: `/api/file/firmware/${fileName}` 
  });
};
